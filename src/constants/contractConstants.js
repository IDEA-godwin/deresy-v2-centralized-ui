...
export const EAS_REVIEWS_SCHEMA_ID = process.env.VUE_APP_EAS_REVIEWS_SCHEMA_ID;

export const EAS_AMENDMENT_SCHEMA_ID =
  process.env.VUE_APP_EAS_AMENDMENT_SCHEMA_ID;
